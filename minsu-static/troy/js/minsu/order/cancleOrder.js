...
/*房东取消订单——首晚房费或者100元*/
					...
					$("#switchCancelAngel").val(data.data.switchCancelAngel);
...
/* 3：更细排序因子" 以下三项在一行;*/
		  ...
		  _html +="<div class='checkbox i-checks'>";
		  _html +="<label>";
		  _html +="<input type='checkbox' id='isUpdateRankFactor' checked='checked' disabled='disabled' name='isUpdateRankFactor' value=''> <i></i>更细排序因子";
