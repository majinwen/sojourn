!function(e, t, i, n) {
   ...
   // var uaType='';
    ...
    var a = 30, r = 90, s = 40, c = 10, l = e.rad2deg = function(e) {
        ...
        var i = this;
        i.holder = e, i.options = t || {}, i.init(), i.initInertiaParams(), i.calcElementItemPostion(!0), 
        i.bindEvent();
    };
    p.prototype.findElementItems = function() {
        ...
        var e = this;
        e.list = e.holder.querySelector("ul"), e.findElementItems(), e.height = e.holder.offsetHeight, 
        e.r = e.height / 2 - c, e.d = 2 * e.r, e.itemHeight = e.elementItems.length > 0 ? e.elementItems[0].offsetHeight : s, 
        e.itemAngle = parseInt(e.calcAngle(iScale * e.itemHeight)), e.hightlightRange = e.itemAngle / 2, 
        e.visibleRange = r, e.beginAngle = 0, e.beginExceed = e.beginAngle - a, e.list.angle = e.beginAngle, 
        ...
        e && (t.items = []), t.elementItems.forEach(function(i) {
            ...
            if (t.endAngle = t.itemAngle * n, i.angle = t.endAngle, i.style.webkitTransformOrigin = "center center -" + t.r + "px", 
        ...
        t.elementItems.forEach(function(i) {
            ...
            i.classList.remove("highlight")) : (i.classList.remove("highlight"), i.classList.remove("visible"));
        });
        ...
        t.holder.addEventListener(e.EVENT_START, function(e) {
            ...
            if (a) {
                ...
                l > t.endExceed && (l = t.endExceed), l < t.beginExceed && (l = t.beginExceed), 
                t.setAngle(l), t.updateInertiaParams(e);
            }
        ...
        return o + d < t.beginExceed && (d = t.beginExceed - o, c = c * (d / u) * .6), o + d > t.endExceed && (d = t.endExceed - o, 
        c = c * (d / u) * .6), 0 == d ? void t.endScroll() : void t.scrollDistAngle(n, o, d, c);
        ...
        var e = this;
        if (e.list.angle < e.beginAngle) e.list.style.webkitTransition = "50ms ease-out", 
        e.setAngle(e.beginAngle); else if (e.list.angle > e.endAngle) e.list.style.webkitTransition = "550ms ease-out", 
        e.setAngle(e.endAngle); else {
        ...
        }), t.list.innerHTML = i.join(""), t.findElementItems(), t.calcElementItemPostion(), 
        t.setAngle(t.correctAngle(t.list.angle)), t.triggerChange(!0);
    ...
    e.PopPicker = e.Class.extend({
        init: function(n) {
            var a = this;
            a.options = n || {}, a.options.buttons = a.options.buttons || [ "取消", "确定" ], a.panel = e.dom(i)[0], 
            t.body.appendChild(a.panel), a.ok = a.panel.querySelector(".mui-poppicker-btn-ok"), 
            a.cancel = a.panel.querySelector(".mui-poppicker-btn-cancel"), a.body = a.panel.querySelector(".mui-poppicker-body"), 
            a.mask = e.createMask(), a.cancel.innerText = a.options.buttons[0], a.ok.innerText = a.options.buttons[1], 
        ...
        show: function(i) {
            ...
            var n = this;
            n.callback = i, n.mask.show(), t.body.classList.add(e.className("poppicker-active-for-page")), 
            n.panel.classList.add(e.className("active")), n.__back = e.back, e.back = function() {
                n.hide();
            };
        },
        hide: function() {
            var i = this;
            i.disposed || (i.panel.classList.remove(e.className("active")), i.mask.close(), 
            t.body.classList.remove(e.className("poppicker-active-for-page")), e.back = i.__back);
        },
        dispose: function() {
            var e = this;
    ...
    var i = '<div class="mui-dtpicker" data-type="datetime">		<div class="mui-dtpicker-header">			<button data-id="btn-cancel" class="mui-btn">取消</button>			<button data-id="btn-ok" class="mui-btn mui-btn-blue">确定</button>		</div>		<div class="mui-dtpicker-title"><h5 data-id="title-y">室</h5><h5 data-id="title-m">厅</h5><h5 data-id="title-d">厨</h5><h5 data-id="title-h">卫</h5><h5 data-id="title-i">阳</h5></div>		<div class="mui-dtpicker-body">			<div data-id="picker-y" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-m" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-d" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-h" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-i" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>		</div>	</div>';
    e.DtPicker = e.Class.extend({
        ...
        getSelected: function() {
            ...
            switch (i) {
              case "datetime":
                 n.value = n.y.value + "室" + n.m.value + "厅" + n.d.value + "厨" + n.h.value + "卫" + n.i.value +"阳", 
                n.text = n.y.text + "室" + n.m.text + "厅" + n.d.text + "厨" + n.h.text + "卫" + n.i.text+"阳";

             
                
            }
            document.getElementById('sIpt').value = n.y.value;
            document.getElementById('tIpt').value = n.m.value;
            document.getElementById('cIpt').value = n.d.value;
            document.getElementById('wIpt').value = n.h.value;
            document.getElementById('yIpt').value = n.i.value;
            return n;
        },
        setSelectedValue: function(e) {
            var t = this, i = t.ui, n = t._parseValue(e);
            
            var sIpt = !document.getElementById('sIpt').value ? 0 : document.getElementById('sIpt').value;
            var tIpt = !document.getElementById('tIpt').value ? 0 : document.getElementById('tIpt').value;
            var cIpt = !document.getElementById('cIpt').value ? 0 : document.getElementById('cIpt').value;
            var wIpt = !document.getElementById('wIpt').value ? 0 : document.getElementById('wIpt').value;
            var yIpt = !document.getElementById('yIpt').value ? 0 : document.getElementById('yIpt').value;

            
            i.y.picker.setSelectedValue(sIpt, 0, function() {
            	
                i.m.picker.setSelectedValue(tIpt, 0, function() {
                	
                    i.d.picker.setSelectedValue(cIpt, 0, function() {
                    	
                        i.h.picker.setSelectedValue(wIpt, 0, function() {
                        	
                            i.i.picker.setSelectedValue(yIpt, 0);
                        });
                    });
                });
            });
        ...
        _parseValue: function(e) {
            ...
            if (e) {
                ...
                var n = new Date();
                t.y = n.getFullYear(), t.m = n.getMonth() + 1, t.d = n.getDate(), t.h = n.getHours(), 
                t.i = n.getMinutes();
            }
            return t;
        },
        _create: function(e) {
            var t = this;
            e = e || {}, e.labels = e.labels || [ "卧", "厅", "厨", "卫", "阳" ], e.buttons = e.buttons || [ "取消", "确定" ], 
            e.type = e.type || "datetime", 
            e.customData = e.customData || {}, 
            t.options = e;
            var i = new Date(), n = e.beginDate;
            n instanceof Date && !isNaN(n.valueOf()) && (e.beginYear = n.getFullYear(), e.beginMonth = n.getMonth() + 1, 
            e.beginDay = n.getDate(), e.beginHours = n.getHours(), e.beginMinutes = n.getMinutes());
            var a = e.endDate;
            a instanceof Date && !isNaN(a.valueOf()) && (e.endYear = a.getFullYear(), e.endMonth = a.getMonth() + 1, 
            e.endDay = a.getDate(), e.endHours = a.getHours(), e.endMinutes = a.getMinutes()), 
            e.beginYear = e.beginYear || i.getFullYear() - 5, e.endYear = e.endYear || i.getFullYear() + 5;
            var r = t.ui;
            t._setLabels(), t._setButtons(), r.picker.setAttribute("data-type", e.type), t._createYear(), 
            t._createMonth(), t._createDay(), t._createHours(), t._createMinutes(), t.setSelectedValue(e.value);
        },
        show: function(i) {
            var n = this, a = n.ui;
            n.callback = i || e.noop, a.mask.show(), t.body.classList.add(e.className("dtpicker-active-for-page")), 
            a.picker.classList.add(e.className("active")), n.__back = e.back, e.back = function() {
                n.hide();
            };
        },
        hide: function() {
            ...
            if (!i.disposed) {
                var n = i.ui;
                n.picker.classList.remove(e.className("active")), n.mask.close(), t.body.classList.remove(e.className("dtpicker-active-for-page")), 
                e.back = i.__back;
            }
        },
        dispose: function() {
