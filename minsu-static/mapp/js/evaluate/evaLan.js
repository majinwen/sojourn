(function ($) {
	...
	$("#submitStar").click(function(){
		...
		if((content==null||content==""||content==undefined)){
			showShadedowTips("请填写评价内容",1);
			canClick = true;
			return false;
		}
		if(landlordSatisfied == 0||landlordSatisfied==null||landlordSatisfied==""||landlordSatisfied==undefined){
			showShadedowTips("请选择星级",1);
			canClick = true;
			return false;
		}
	...
	evaLan.init = function(){
		...
		myScroll = new IScroll('#con', { scrollbars: true,probeType:3,mouseWheel: true });
