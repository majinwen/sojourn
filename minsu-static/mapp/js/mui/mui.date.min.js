...
function(e, t, i, a) {
	...
	p.prototype.findElementItems = function() {
		...
		e.itemAngle = parseInt(e.calcAngle(iScale * e.itemHeight)), 
		e.hightlightRange = e.itemAngle / 2, 
		e.visibleRange = r, 
		e.beginAngle = 0, e.beginExceed = e.beginAngle - n, e.list.angle = e.beginAngle, u && (e.list.style.webkitTransformOrigin = "center center " + e.r + "px")
