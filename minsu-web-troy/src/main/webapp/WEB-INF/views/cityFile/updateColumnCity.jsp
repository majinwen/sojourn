...
<html>
  ...
  <body class="gray-bg">
	   <div class="wrapper wrapper-content animated fadeInRight">
	   	<form action="cityFile/updateColumnCityOk" method="post" id="saveColumnCity">
	   	   <input type="hidden" name="fid" value="${columnCityEntity.fid }">
	       <div class="row">
	           <div class="col-sm-12">
	               <div class="ibox float-e-margins">
				  	   <div class="ibox-content">
				           	<div class="form-group">
		                           ...
		                           <div class="col-sm-1">
	                                   ...
	                                   <c:forEach items="${tempList }" var="temp">
	                                   		<option value="${temp.fid }" ${columnCityEntity.tempFid==temp.fid?'selected':'' }>${temp.tempName }</option>
	                                   </c:forEach>
	                                   </select>
	                               </div>
		                       </div>
		                       <div class="row">
		                           ...
		                           <div class="col-sm-1">
	                                   <select class="form-control m-b" name="cityCode" disabled="disabled">
		                                   <option value="">请选择</option>
		                                   <c:forEach items="${cityList }" var="temp">
		                                   		<option value="${temp.code }"  ${columnCityEntity.cityCode==temp.code?'selected':'' }>${temp.name }</option>
		                                   </c:forEach>
	                                   </select>
	                               </div>
		                       </div>
		                       <div class="row">
		                           ...
		                           <div class="col-sm-3">
	                                   <input name="colTitle" value="${columnCityEntity.colTitle }" type="text" class="form-control m-b" required>
	                               </div>
		                       </div>
		                       <div class="row">
		                       	   <div class="col-sm-1">
		                           ...
		                           <div class="col-sm-3">
	                                   <input name="colDeputyTitle" value="${columnCityEntity.colDeputyTitle }"  type="text" class="form-control m-b" >
	                               </div>
		                       </div>
		                       <div class="row">
		                       	   <div class="col-sm-1">
		                           ...
		                           <div class="col-sm-3">
	                                   <input name="colShareTitle" value="${columnCityEntity.colShareTitle }"  type="text" class="form-control m-b" >
	                               </div>
		                       </div>
		                       <div class="row">
	                               <div class="col-sm-1">
		                           ...
		                           <div class="col-sm-3">
	                                   <input name="colBackColor" value="${columnCityEntity.colBackColor}"  type="text" class="form-control m-b" >
	                               </div>                       
	                           </div>
			               </div>
			           </div>
       		       ...
       		       <div class="col-sm-4 col-sm-offset-2">
	                   <customtag:authtag authUrl="cityFile/updateColumnCityOk"><button class="btn btn-primary" type="submit" >保存内容</button></customtag:authtag>
	               </div>
	           </div>
	       </div>
	   </form>
       ...
       <script type="text/javascript">
		...
		$("#saveColumnCity").validate({
			submitHandler:function(){
				$.ajax({
		            type: "POST",
		            url: "cityFile/updateColumnCityOk",
		            dataType:"json",
