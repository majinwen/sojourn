  ...
  <body class="gray-bg">
                                   ...
                                   <div class="ibox float-e-margins">
                                       <div class="ibox-content">
                                           <form id="region4" class="form-horizontal m-t">
                                               ...
                                               <input id="regionFidM" type="hidden" name="regionFid" value="">
       ...
       <script type="text/javascript">
        ...
        $("#regionInfo").click(function () {
            var regionFid = $("#regionFid").find("option:selected").val();
            var regionName=$("#regionFid").find("option:selected").text();
//			alert(regionFid+regionName);
            if(isNullOrBlank(regionFid) || isNullOrBlank(regionName)){
                alert("请选择一个专栏操作");
                return;
            }
            $.ajax({
...
//          alert("保存被单击了");
            var hotRegionFid = $.trim($("#regionFidM").val());
