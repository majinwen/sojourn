...
<body class="gray-bg">
						...
						<form id="form" class="form-horizontal">
							...
							<div class="row">
								<div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select class="form-control m-b" id="surveyResult" disabled="disabled">
							...
							<div class="row">
								<div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <input type="text" class="form-control m-b"  id="surveyDate" value="<fmt:formatDate value="${houseSurveyMsg.surveyDate }" pattern="yyyy-MM-dd"/>" readonly="readonly">
	                                </div>
							...
							<div class="row">
								<div class="form-group">
			                        ...
			                        <div class="col-sm-5">
			                            <textarea rows="3" id="remark" name="remark" class="form-control m-b" onkeydown="calNum(this)" onkeyup="calNum(this)" onchange="calNum(this)" disabled="disabled">${houseSurveyMsg.remark }</textarea>
	...
	<script>
	    ...
	    function auditHouseSurvey(){
	    	$.ajax({
	            type: "post",
	            url: "house/houseSurvey/auditHouseSurvey",
	            dataType:"json",
