					                    ...
					                    <div class="col-sm-12">
					                        <div class="example-wrap">
					                            <div class="example">
								                    ...
								                    data-url="house/houseMgt/showHouseMsgList">                    
								                    <thead>
								                        <tr>
	   ...
	   <script>
		   $(function(){
			...
			function formateHouseSn(value, row, index){
				 return "<a href='javascript:;' class='oneline line-width' title=\""+value+"\" <customtag:authtag authUrl='house/houseMgt/upHouseDetail'>onclick='showHouseDetail(\""+row.fid+"\");'</customtag:authtag>>"+value+"</a>";
			}
			
			// 合租房间名称
			function formateRoomSn(value, row, index){
				return "<a href='javascript:;' class='oneline line-width' title=\""+value+"\" <customtag:authtag authUrl='house/houseMgt/upHouseDetail'>onclick='showRoomDetail(\""+row.fid+"\");'</customtag:authtag>>"+value+"</a>";
			}
			
			//展示房源详情
			function showHouseDetail(houseBaseFid){
				$.openNewTab(new Date().getTime(),'house/houseMgt/upHouseDetail?rentWay=0&houseFid='+houseBaseFid, "房源详情");
			}
			
			//展示房间详情
			function showRoomDetail(houseRoomFid){
				$.openNewTab(new Date().getTime(),'house/houseMgt/upHouseDetail?rentWay=1&houseFid='+houseRoomFid, "房间详情");
			}
		</script>
	</body>
</html>
