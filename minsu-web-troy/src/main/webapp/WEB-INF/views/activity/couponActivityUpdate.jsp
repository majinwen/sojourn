...
<html>
 ...
 <body class="gray-bg">
			           ...
			           <form id="activityForm" action="#" class="form-horizontal" onsubmit="return false" method="post" >
	                           ...
	                           <div class="hr-line-dashed"></div>
								...
								<div class="row">
									...
									<div class="col-sm-2">
										<select id="groupSnSelect" name="groupSn" class="form-control">
								...
								<div class="row">
									<div class="col-sm-1 ">
										<div id="allCheckBox" class="checkbox i-checks">
											<label>
												<input id="allCityCheckBox" name="allCityCode" type="checkbox" value="${all}" > <i></i>全部
											</label>
										</div>
									</div>
			               ...
			               <div class="form-group">
							   ...
							   <div class="row">
								   ...
								   <div class="col-sm-2" id="timeDiv" style="display: none">
									   <input name="times" value="${activity.times}" type="text" class="form-control m-b" required>
								   </div>
							   ...
							   <div class="row">
								   ...
								   <div class="col-sm-6 limitHouseDiv" style="display: none">
									   <input name="limitHouseSns" id="limitHouseSns"  value="${houseSns}" type="text" class="form-control" required>
								   </div>
							   ...
							   <div class="row">
								   ...
								   <div id="couponTimeLastDiv"  style="display: none" >
									   ...
									   <div class="col-sm-2">
										   <input name="couponTimeLast" id="couponTimeLast"  value="${activity.couponTimeLast}" type="text" class="form-control m-b" required>
									   </div>
								   </div>
                           ...
                           <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <button id="saveAc" class="btn btn-primary" type="submit" >保存内容</button>
                                </div>
                           </div>
                        </form>
			        </div>
    ...
    <script src="${basePath}js/minsu/common/commonUtils.js${VERSION}008" ></script>
...
//				setCheckBoxSelected('allCityCheckBox','cityCheckBox','cityCodeArray');
        ...
        var activityTypeOper = function(type){
    		...
    		if(type == 1){
				...
				html +='<input name="actMax" value="${activity.actMax/100}" type="text" class="form-control m-b" required>';
				html +='</div>';
				html +='<div class="col-sm-1">';
				html +='<input name="actCut" value="${activity.actCut }" type="text" class="form-control m-b" required>';
				html +='</div>'
				html +=	'<label class="col-sm-1 control-label" style="text-align: left">折</label>';
