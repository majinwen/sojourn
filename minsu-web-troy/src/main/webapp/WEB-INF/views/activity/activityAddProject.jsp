									...
									<div class="row">
										<div class="col-sm-6">
											...
											<div class="col-sm-3 left2">
												<select id="city" name="city" class="form-control m-b m-b">
										...
										<div class="col-sm-6">
											<div class="col-sm-3 left2">
												<button class="btn btn-primary" type="button" onclick="queryProjectList();">
								...
								<div class="example-wrap">
									<div class="example">
										<table id="listTable" class="table table-bordered table-hover" data-click-to-select="true"
											   ...
											   data-method="post"
											   data-height="500"
											   data-url="activityGroup/projectList">
											<thead>
											<tr class="trbg">
												<th data-field="id" data-width="5%" data-checkbox="true"></th>
												<th data-field="fname" data-width="10%" data-align="center">项目名称</th>
...
<script type="text/javascript">
	...
	function addGroupHouseRel() {
        ...
        selectVar.forEach(function(v,index){
            var groupHouseRel = {};
			groupHouseRel.projectId = v.fid;
			groupHouseRel.groupFid = $('#groupFid').val();
			groupHouseRel.houseType = 1;
