 ...
 <body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
			           <form id="activityForm" action="" class="form-horizontal" onsubmit="document.charset='utf-8'" method="post" >
						   ...
						   <input type="hidden" name="serviceLine" value="${activity.serviceLine}">
							<div class="form-group">
								<div class="row">
									<label class="col-sm-1 control-label mtop">业务线:</label>
									<div class="col-sm-2">
										<select id="serviceLine" class="form-control" disabled>
											<option value="1" <c:if test="${activity.serviceLine == 1}">selected</c:if>>
												民宿
											</option>
											<option value="2" <c:if test="${activity.serviceLine == 2}">selected</c:if>>
												公寓
											</option>
										</select>
									</div>
								...
								<div class="row row-top">
									...
									<div class="col-sm-2">
										<input id="actName" name="actName" value="${activity.actName}" type="text"
								...
								<div class="row row-top zra-show">
									...
									<div class="col-sm-1">
										<select id="actTypeSelect" class="form-control" name="actType" required>
											...
											<option value="21" <c:if test="${activity.actType == 21}">selected</c:if>>
												满减(天)
											</option>
										</select>
									</div>
									...
									<div class="discount2" style="display: none">
										<div class="col-sm-1">
											<div class="col-sm-10"><input type="text" value="${activity.actCut}"
										...
										<div class="col-sm-2">
											...
											<div class="col-sm-8"><input type="text" id="discount_actmax"
									...
									<div class="cut21" style="display: none">
										<div class="col-sm-1">
											...
											<div class="col-sm-10"><input type="text" id="cut_actlimit"
										...
										<div class="col-sm-1">
											...
											<div class="col-sm-10"><input type="text" id="cut_actcut"
												...
												<div class="checkbox i-checks">
													<c:if test="${obj.giftFlag == 1 }">
														<label class="gift_lable">
															<input type="checkbox" flag="1" checked="checked"
								...
								<div class="row row-top">
									...
									<div class="col-sm-2">
										<input id="actStartTime" name="sActStartTime" value=""
											   class="laydate-icon form-control layer-date">
									</div>
									<label class="col-sm-1 control-label">到:</label>
									<div class="col-sm-2">
										<input id="actEndTime" name="sActEndTime" value=""
											   class="laydate-icon form-control layer-date">
									</div>
								</div>
								...
								<div class="row row-top zra-show">
									...
									<div class="col-sm-2">
										<select id="customerType" name="customerType" class="form-control">
											...
											<option value="1"
													<c:if test="${activity.customerType == 1}">selected</c:if>>个人
											</option>
											<option value="2"
													<c:if test="${activity.customerType == 2}">selected</c:if>>企业
											</option>
										</select>
									</div>
									...
									<div class="col-sm-2">
										<select id="signType" name="signType" class="form-control">
											<option value="0">不限制</option>
											<option value="1" <c:if test="${activity.signType == 1}">selected</c:if>>
												新签
											</option>
											<option value="2" <c:if test="${activity.signType == 2}">selected</c:if>>
												续约
											</option>
										</select>
									</div>
								...
								<div class="row row-top minsu-show">
									...
									<div class="col-sm-1">
										<div id="allCheckBox" class="checkbox i-checks">
											<input id="allCityCheckBox" name="allCityCode" type="checkbox"
												   value="${all}">全部
										</div>
									</div>
						   ...
						   <div class="form-group">
								<div class="col-sm-4 col-sm-offset-2">
									<button id="updateBtn" class="btn btn-primary" type="button">保存内容</button>
								</div>
							</div>
						</form>
			        </div>
    ...
    <script>
        ...
        $("#updateBtn").click(function(){
            ...
            $("div:hidden").remove();
	    	$.ajax({
				url:"normalActivity/updateActivity",
