...
<body class="fixed-sidebar full-height-layout gray-bg skin-2" style="overflow:auto">
<div id="wrapper">
    <!--左侧导航开始-->
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
           <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="javascript:void();" style="position: absolute; right: 10px; top: 0px; z-index: 999;"><i class="fa fa-bars"></i> </a>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
            		<div class="ibox-content clearfix">
						<h1 class="threed"><strong>特洛伊后台管理系统</strong></h1>
                    </div>
            </nav>
        </div>
