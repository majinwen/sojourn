 ...
 <body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
			           <form id="activityForm" action="" class="form-horizontal" onsubmit="document.charset='utf-8'" method="post" >
			           		<input type="hidden" id="activitySn" name="activitySn" value="${activity.activitySn}">
							<div class="form-group">
								<div class="row">
									<label class="col-sm-1 control-label mtop">活动名称:</label>
									<div class="col-sm-2">
										<input id="activityName" name="activityName" value="${activity.activityName}" type="text" class="form-control m-b" maxlength="20">
									</div>
								...
								<div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <input id="actCut" name="actCut" value="${activity.actCut}"  type="text" class="form-control m-b" maxlength="20">
                                    </div>
    ...
    <script>
        $(function (){
        	...
        	$("#startTime").val(CommonUtils.formateDateTime('${activity.startTime }'));
        	$("#endTime").val(CommonUtils.formateDateTime('${activity.endTime }'));
        	CommonUtils.selectedDefault('activityType','${activity.activityType}','');
        	CommonUtils.selectedDefault('cityCode','${activity.cityCode}','');
        ...
        $("#updateBtn").click(function(){
	    	...
	    	$.ajax({
				url:"cmsactivity/updateActivity",
				data:{
					activity : activity
				},
				dataType:"json",
