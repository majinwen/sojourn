 ...
 * @version 1.0
 */
public class Timeout extends BaseAjaxValue {
	
	/**
	 * 超时CODE
	 */
	private String statusCode = CODE_TIMEOUT;
	
	/**
	 * 默认消息
	 */
	private String message = "回话超时";
	 ...
	 */
	public Timeout(String message, String navTabId, String rel, String callbackType, String forwardUrl) {
		this.message = message;
