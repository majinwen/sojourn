...
import com.asura.amp.dubbo.common.utils.ParseUtils;
...
public class ProviderServiceImpl extends AbstractService implements ProviderService {
	...
	public void enableProvider(Long id) {
		...
		if (oldProvider.isDynamic()) {
			...
			List<DynamicConfig> oList = overrideService.findByServiceAndAddress(oldProvider.getService(),
	...
	public void setWeight(Long id, float factor) {
		...
		if (oldProvider.isDynamic()) {
			// 保证disable的override唯一
			List<DynamicConfig> overrides = overrideService.findByServiceAndAddress(oldProvider.getService(),
					oldProvider.getAddress());
