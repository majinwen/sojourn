 ...
 * with Alibaba.com.
 */
package com.asura.amp.dubbo.common.entity;
...
import com.asura.amp.dubbo.common.utils.RegistryConvertUtil;
 ...
 * @author tony.chenl
 */
public class Provider extends DubboBaseEntity {
    ...
    private DynamicConfig override;

	private List<DynamicConfig> overrides;
    ...
    public DynamicConfig getOverride() {
		return override;
	}

	public void setOverride(DynamicConfig override) {
		this.override = override;
	}

	public List<DynamicConfig> getOverrides() {
		return overrides;
	}

	public void setOverrides(List<DynamicConfig> overrides) {
		this.overrides = overrides;
	}

    public URL toUrl() {
        Map<String, String> serviceName2Map = RegistryConvertUtil.serviceName2Map(getService());
