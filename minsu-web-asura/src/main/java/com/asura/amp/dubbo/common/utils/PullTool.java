...
import com.asura.amp.dubbo.common.string.StringEscapeUtils;
...
public class PullTool {
    ...
    public boolean isProviderEnabled(Provider provider){
    	List<DynamicConfig> oList = overrideService.findByServiceAndAddress(provider.getService(), provider.getAddress());
    	return isProviderEnabled(provider, oList);
    }
    
    public static boolean isProviderEnabled(Provider provider, List<DynamicConfig> oList){
    	for(DynamicConfig o : oList){
    ...
    public static int getProviderWeight(Provider provider, List<DynamicConfig> oList) {
    	for(DynamicConfig o : oList){
    		if (o.isMatch(provider)) {
	    		Map<String, String> params = StringUtils.parseQueryString(o.getParams());
    ...
    public String getOverridesMock(List<DynamicConfig> overrides){
...
//    public boolean checkUrl(Operator user,String uri){
//        return true;
