	...
	<form method="post" action="quartz/add.do" class="pageForm required-validate" onsubmit="return validateCallback(this, addTriggerAjaxDone)">
		<div class="pageFormContent" layoutH="58">
			<div class="unit">
                ...
                <select size="50" class="combox" name="group">
                    <option value="minsu-basedata" >&nbsp;&nbsp;&nbsp;minsu-basedata&nbsp;&nbsp;&nbsp;</option>
                    <option value="minsu-customer" >&nbsp;&nbsp;&nbsp;minsu-customer&nbsp;&nbsp;&nbsp;</option>
                    <option value="minsu-evaluate" >&nbsp;&nbsp;&nbsp;minsu-evaluate&nbsp;&nbsp;&nbsp;</option>
                    <option value="minsu-house" >&nbsp;&nbsp;&nbsp;minsu-house&nbsp;&nbsp;&nbsp;</option>
                    <option value="minsu-order" >&nbsp;&nbsp;&nbsp;minsu-order&nbsp;&nbsp;&nbsp;</option>
                    <option value="minsu-search" >&nbsp;&nbsp;&nbsp;minsu-search&nbsp;&nbsp;&nbsp;</option>
                    <option value="minsu-cms" >&nbsp;&nbsp;&nbsp;minsu-cms&nbsp;&nbsp;&nbsp;</option>
                    <option value="minsu-other" >&nbsp;&nbsp;&nbsp;minsu-other&nbsp;&nbsp;&nbsp;</option>
					<option value="zrp-houses" >&nbsp;&nbsp;&nbsp;zrp-houses&nbsp;&nbsp;&nbsp;</option>
					<option value="zrp-trading" >&nbsp;&nbsp;&nbsp;zrp-trading&nbsp;&nbsp;&nbsp;</option>
