...
<script type="text/javascript">
	function editAddrWeightsAjaxDone(json) {
...
<div class="pageContent">
	<form class="required-validate" action="servicecenter/service/weights/edit.do" method="post" onsubmit="return validateCallback(this, editAddrWeightsAjaxDone)">
