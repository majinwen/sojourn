...
<div class="pageContent j-resizeGrid">
	<div class="pageHeader" style="border:1px #B8D0D6 solid">
		<form id="pagerForm" onsubmit="return navTabSearch(this);" action="servicecenter/search/alladdress.do" method="post">
			...
			<div class="searchBar">
				<table class="searchContent">
					<tr>
						...
						<td><sf:button title="检索" url="servicecenter/search/alladdress.do"></sf:button></td>
					</tr>
				</table>
			</div>
		</form>
	...
	<div class="pageContent" style="border-left:1px #B8D0D6 solid;border-right:1px #B8D0D6 solid">
		<table class="table" layoutH="100" rel="search_addressContainer">
			<thead>
				<tr>
