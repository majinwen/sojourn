...
<script type="text/javascript">
	function addRoutesAjaxDone(json) {
		$('#service_routesContainer').loadUrl('servicecenter/service/routes.do?search_service=${empty param.service? route.service : param.service}');
		alertMsgByJson(json);
...
<div class="pageContent">
	<form class="required-validate" action="servicecenter/service/routes/add.do" method="post" onsubmit="return validateCallback(this, addRoutesAjaxDone)">
		<div class="pageFormContent" layoutH="56">
			...
			<p style="width:100%;">
				...
				<c:if test="${empty route.service and empty param.service}">
					<input type="text" id="address_service" name="service" value="${empty param.service? route.service : param.service}" size="50" />
