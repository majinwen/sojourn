...
<div class="pageContent j-resizeGrid">
	<div class="pageHeader" style="border:1px #B8D0D6 solid">
		<form id="pagerForm" onsubmit="return navTabSearch(this);" action="servicecenter/search/allservice.do" method="post">
			...
			<div class="searchBar">
				<table class="searchContent">
					<tr>
						...
						<td><sf:button title="检索" url="servicecenter/search/allservice.do"></sf:button></td>
					</tr>
				</table>
			</div>
		</form>
	...
	<div class="pageContent" style="border-left:1px #B8D0D6 solid;border-right:1px #B8D0D6 solid">
		<table class="table" layoutH="100" rel="search_serviceContainer">
			<thead>
				<tr>
					<th width="550">服务名</th>
					<th width="130">状态</th>
