                ...
                <div class="col-sm-12">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                            ...
                            <div style="width: 100%;">
                                    <span style="color: red">tips:房客评价率环比指的是查询时间段内房客的评价率与查询时间段向前推移同样天数的时间段内房客评价率的百分比。</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function init(){
        $("#jqGrid").jqGrid({
            url: 'orderEval/orderEvaList',
            mtype: "GET",
            datatype: "json",
            colModel: [
                {label: '大区', name: 'regionName', key: true, width: 75},
                {label: '城市', name: 'cityName', width: 100},
                {label: '订单数', name: 'orderNum', width: 100},
                {label: '房客评价量', name: 'tenNum', width: 100},
                {label: '房东评价量', name: 'lanNum', width: 100},
                {label: '房客评价率', name: 'tenRate', width: 100,formatter:showInfo},
                {label: '房东评价率', name: 'lanRate', width: 100,formatter:showInfo},
                {label: '房客评价率环比', name: 'tenInfo', width: 100,formatter:showInfo}
            ],
    ...
    function exportFile(){
        ...
        window.location.href = "orderEval/orderEvaListExcel?starTimeStr="+starTimeStr+"&endTimeStr="+endTimeStr+"&nationCode="+nationCode;
    }
