...
<script type="text/javascript">
    ...
    function init(){
        $("#jqGrid").jqGrid({
            url: 'orderNum/orderNumList',
            mtype: "GET",
            datatype: "json",
            colModel: [
                {label: '大区', name: 'regionName', key: true, width: 75},
                {label: '城市', name: 'cityName', width: 100},
                {label: '咨询量', name: 'consoltNum', width: 100},
                {label: '申请量', name: 'applyNum', width: 100},
                {label: '房东接单量', name: 'acceptNum', width: 100},
                {label: '房客支付量', name: 'payNum', width: 100},
                {label: '房东接单率', name: 'acceptRate', width: 100,formatter:showInfo},
                {label: '房客支付率', name: 'payRate', width: 100,formatter:showInfo},
                {label: '订单成功率', name: 'successRate', width: 100,formatter:showInfo},
                {label: '客户量', name: 'userNum', width: 100},
                {label: '成功客户量', name: 'successUserNum', width: 100},
                {label: '房客预定成功率', name: 'successUserRate', width: 100,formatter:showInfo}
            ],
...
//                nationCode: $('#nation option:selected').val(),
    ...
    function exportFile(){
        ...
        window.location.href = "orderNum/orderNumListExcel?starTimeStr="+starTimeStr+"&endTimeStr="+endTimeStr+"&nationCode=100000";
    }
