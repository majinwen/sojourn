	...
	<div class="row row-lg">
		<div class="tabs-container">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="javascript:void(0)">跟进订单状态数据统计表</a>
				</li>
					...
					<div class="example-wrap">
						<div class="example">
							<table id="listTable" class="table table-bordered table-hover" data-click-to-select="true"
								   ...
								   data-height="500"
								   data-url="orderfollow/followOrderStatusNum">
								<thead>
								<tr class="trbg">
									<th data-field="orderStatus" data-width="10%" data-align="center">客服跟进时状态</th>
									<th data-field="num" data-width="10%" data-align="center">订单数量</th>
								</tr>
								</thead>
							</table>
						</div>
...
<script type="text/javascript">
	...
	function exportFile(){
		...
		var url = "orderfollow/followOrderStatusNumExcel?"+
						"&startTime="+startTime+
						"&endTime="+endTime+
						"&city="+city;
