	...
	<div class="row row-lg">
		<div class="tabs-container">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="javascript:void(0)">刷单信息报表</a>
				</li>
		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
				<div class="ibox-content">
					...
					<div class="row">
						<div class="col-sm-12">
							<label class="col-sm-1 control-label mtop">订单量:</label>
							<div class="col-sm-2 ">
								<input id="orderNumStart" name="orderNumStart" class="form-control m-b">
							</div>

							<label class="col-sm-1 control-label mtop">到:</label>
							<div class="col-sm-2">
								<input id="orderNumEnd" name="orderNumEnd" class="form-control m-b">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<label class="col-sm-1 control-label mtop">优惠券金额:</label>
							<div class="col-sm-2 ">
								<input id="couponMoneyAllStart" name="couponMoneyAllStart" class="form-control m-b">
							</div>

							<label class="col-sm-1 control-label mtop">到:</label>
							<div class="col-sm-2">
								<input id="couponMoneyAllEnd" name="couponMoneyAllEnd" class="form-control m-b">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<label class="col-sm-1 control-label mtop">订单预定时间:</label>
							<div class="col-sm-2 ">
					...
					<div class="example-wrap">
						<div class="example">
							<table id="listTable" class="table table-bordered table-hover" data-click-to-select="true"
								   ...
								   data-height="500"
								   data-url="orderDetail/getOrderFresh">
								<thead>
								<tr class="trbg">
									...
									<th data-field="houseNum" data-align="center">房源条数</th>
									<th data-field="orderNum" data-align="center">订单量</th>
									<th data-field="couponNum" data-align="center">优惠券订单量</th>
									<th data-field="rentalMoneyAll" data-align="center">订单房租金额</th>
									<th data-field="couponMoneyAll" data-align="center">优惠券金额</th>
								</tr>
								</thead>
							</table>
						</div>
...
<script type="text/javascript">
	...
	function paginationParam(params) {
		return {
			...
			region:$('#region').val(),
			city:$('#city').val(),
			orderNumStart:$('#orderNumStart').val(),
			orderNumEnd:$('#orderNumEnd').val(),
			couponMoneyAllStart:$('#couponMoneyAllStart').val(),
			couponMoneyAllEnd:$('#couponMoneyAllEnd').val(),
	...
	function exportFile(){
		...
		var city = $('#city').val();
		var orderNumStart = $('#orderNumStart').val();
		var orderNumEnd = $('#orderNumEnd').val();
		var couponMoneyAllStart = $('#couponMoneyAllStart').val();
		var couponMoneyAllEnd = $('#couponMoneyAllEnd').val();
		var createStartTime = $('#createStartTime').val();
		var createEndTime = $('#createEndTime').val();
		var url = "orderDetail/orderFreshExcel?"+
						"region="+region+
						"&city="+city+
						"&orderNumStart="+orderNumStart+
						"&orderNumEnd="+orderNumEnd+
						"&couponMoneyAllStart="+couponMoneyAllStart+
						"&couponMoneyAllEnd="+couponMoneyAllEnd+
