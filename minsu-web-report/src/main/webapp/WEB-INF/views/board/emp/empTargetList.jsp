                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-1 text-right mtop">
                                <label class="control-label">限制每页专员：</label>
                            </div>
                            <div class="col-sm-1">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#jqGrid").jqGrid({
            ...
            datatype: "json",
            colModel: [
                 {label: '专员',align:"center", name: 'empName', width: 200,sortable :false},
                 {label: '专员编号',align:"center", name: 'empCode', width: 200,sortable :false},
                 {label: '专员codeName',align:"center", name: 'empCodeName',hidden: true,sortable :false},
                 {label: '目标月份', align:"center",name: 'targetMonth',width: 200,sortable :false},
                 {label: '房源上架目标', align:"center",name: 'targetHouseNum',width: 200,sortable :false},
                 {label: '操作', name: 'isSet',align:"center", width: 200,formatter:targetSet,sortable :false}
            ],
            jsonReader: {
   ...
   function targetSet(value, index, row) {
       if (value == 1){
           return '<button class="btn btn-primary btn-xs" type="button" style="margin: 0;" data-toggle="modal" ' +
                   'data-target="#cityTargetModal"  onclick="setEmpTarget(\''+row.empCode+'\')">设置</button>';
       }else{
           return '';
       }
   }
