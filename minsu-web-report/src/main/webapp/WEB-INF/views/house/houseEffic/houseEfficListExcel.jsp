	...
	<div class="row row-lg">
		<div class="tabs-container">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="javascript:void(0)">房源效率报表</a>
				</li>
					...
					<div class="example-wrap">
						<div class="example">
							<table id="listTable" class="table table-bordered table-hover" data-click-to-select="true"
								   ...
								   data-height="500"
								   data-url="houseEffic/getHouseEfficVoList"> 
								<thead>
								<tr class="trbg">
									...
									<th data-field="firstAdviceDate" data-align="center" data-formatter="getLocalTime">首次咨询时间</th>
									<th data-field="firstApplyDate" data-align="center" data-formatter="getLocalTime">首次申请时间</th>
									<th data-field="firstPayDate" data-align="center" data-formatter="getLocalTime">首次支付时间</th>
									<th data-field="firstCheckinDate" data-align="center" data-formatter="getLocalTime">首次入住时间</th>
									<th data-field="firstEvalDate" data-align="center" data-formatter="getLocalTime">首次评价时间</th>
								</tr>
								</thead>
							</table>
						</div>
...
<script type="text/javascript">
	...
	function paginationParam(params) {
	 ...
	 function exportFile(){
		...
		var url = "houseEffic/getHouseEfficVoExcel?"+
