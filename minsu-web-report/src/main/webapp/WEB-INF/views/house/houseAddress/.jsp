	...
	<div class="row row-lg">
		<div class="tabs-container">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="javascript:void(0)">订单联系报表</a>
				</li>
						...
						<div class="example">
							<table id="listTable" class="table table-bordered table-hover" data-click-to-select="true"
								...
								<tr class="trbg">
									...
									<th data-field="userName" data-align="center">房客姓名</th>
									<th data-field="userTel" data-align="center">房客电话</th>
									<th data-field="houseSn" data-align="center">房源编号</th>
									<th data-field="landName" data-align="center">房东姓名</th>
									<th data-field="landTel" data-align="center">房东电话</th>
								</tr>
								</thead>
							</table>
						</div>
...
<script type="text/javascript">
	...
	function exportFile(){
		...
		var url = "orderContact/orderContactListExcel?"+
						"nationCode="+nation+
						"&regionFid="+region+
						"&cityCode="+city+
