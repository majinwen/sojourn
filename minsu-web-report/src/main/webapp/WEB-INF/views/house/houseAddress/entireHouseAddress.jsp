		...
		<div class="tabs-container">
			<ul class="nav nav-tabs">
				<li class="active" id="entireLi">
					<a href="javascript:entireHouseAddress();">整租列表</a>
				</li>
				<li id="subLi">
					<a href="javascript:subHouseAddress();">合租列表</a>
				</li>
			</ul>
		</div>
		<div class="col-sm-12">
...
<script type="text/javascript">
    ...
    //导出地址
    var exportUrl='houseAddress/houseAddressExcel?rentWay=0';
    function exportFile(){
	...
	//初始化整租房源地址列表
    function entireHouseAddress(){
    	$("#entireLi").addClass('active');
    	$("#subLi").removeClass('active');
    	exportUrl='houseAddress/houseAddressExcel?rentWay=0';
    	CommonUtils.strapTable('listTable','houseAddress/dataList',paginationParam,columnsData);
    }
    //初始化合租房源地址列表
    function subHouseAddress(){
    	$("#subLi").addClass('active');
    	$("#entireLi").removeClass('active');
    	exportUrl='houseAddress/houseAddressExcel?rentWay=1';
    	CommonUtils.strapTable('listTable','houseAddress/dataList',subPaginationParam,columnsData);
    }
