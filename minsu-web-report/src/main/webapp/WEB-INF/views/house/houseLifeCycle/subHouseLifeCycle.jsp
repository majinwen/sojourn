	...
	<div class="row row-lg">
	    <div class="tabs-container">
             <ul class="nav nav-tabs">
				<li>
					<a href="houseLifeCycle/toEntireHouseLifeCycle">整租列表</a>
				</li>
				<li class="active">
					...
					<div class="example-wrap">
						<div class="example">
						 <table id="listTable" class="table table-bordered table-hover" data-click-to-select="true"
			                    ...
			                    data-height="500"
			                    data-url="houseLifeCycle/dataList">
			                    <thead>
			                        <tr class="trbg">
			                        ...
			                        <th data-field="createDate" data-width="10%" data-align="center" data-formatter="CommonUtils.formateDate">创建日期</th>
			                        <th data-field="publishDate" data-width="10%" data-align="center" data-formatter="CommonUtils.formateDate">发布日期</th>
			                        <!-- <th data-field="grardAccessDate" data-width="10%" data-align="center" data-formatter="CommonUtils.formateDate">管家审核通过日期</th> -->
...
<script type="text/javascript">
    ...
    function exportFile(){
        ...
        var url = "houseLifeCycle/houseLifeCycleExcelList?rentWay=1"+
        		"&beginTime="+beginTime+
        		"&endTime="+endTime+
        		"&cityCode="+cityCode
        		;
