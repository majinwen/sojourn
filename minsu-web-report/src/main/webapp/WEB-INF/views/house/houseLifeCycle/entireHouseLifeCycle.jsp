	    ...
	    <div class="tabs-container">
             <ul class="nav nav-tabs">
				<li class="active" id="entireLi">
					<a href="javascript:entireHouseLife();">整租列表</a>
				</li>
				<li id="subLi">
					<a href="javascript:subHouseLife();">合租列表</a>
				</li>
                      ...
                      <div class="row">
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<customtag:authtag authUrl="houseLifeCycle/dataList">
...
<script type="text/javascript">
    ...
    //导出地址
    var exportUrl='houseLifeCycle/houseLifeCycleExcelList?rentWay=0';
    function exportFile(){
    ...
    //初始化整租房源周期列表
    function entireHouseLife(){
    	$("#entireLi").addClass('active');
    	$("#subLi").removeClass('active');
    	exportUrl='houseLifeCycle/houseLifeCycleExcelList?rentWay=0';
    	CommonUtils.strapTable('listTable','houseLifeCycle/dataList',paginationParam,columnsData);
    }
    //初始化合租房源周期列表
    function subHouseLife(){
    	$("#subLi").addClass('active');
    	$("#entireLi").removeClass('active');
    	exportUrl='houseLifeCycle/houseLifeCycleExcelList?rentWay=1';
    	CommonUtils.strapTable('listTable','houseLifeCycle/dataList',subPaginationParam,columnsData);
    }
</script>
</body>
