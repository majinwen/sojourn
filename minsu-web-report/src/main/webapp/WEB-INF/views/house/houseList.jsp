	    ...
	    <div class="tabs-container">
             <ul class="nav nav-tabs">
				<li class="active" id="entireLi">
					<a href="javascript:entireHouseList();">整租列表</a>
				</li>
				<li id="subLi">
					<a href="javascript:subHouseList();">合租列表</a>
				</li>
				<li id="subTLi">
				   <a href="javascript:subSharedHouseList();">合租按套列表</a>
			    </li>
			 </ul>
          </div>
		 <div class="col-sm-12">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="col-sm-1 left2 left3">
									<customtag:authtag authUrl="house/dataList">
							...
							<div class="col-sm-6">
								<div class="col-sm-1 left2 left3">
									<customtag:authtag authUrl="house/houseDataListExcel">
...
<script type="text/javascript">
    ...
    //导出excel表格
    var exportUrl='house/houseDataListExcel?rentWay=0';
    function exportFile(){
    ...
    //初始化整租房源状态列表
    function entireHouseList(){
    	$("#entireLi").addClass('active');
    	$("#subLi").removeClass('active');
    	$("#subTLi").removeClass('active');
    	exportUrl='house/houseDataListExcel?rentWay=0';
    	CommonUtils.strapTable('listTable','house/dataList',paginationParam,columnsData);
    }
    //初始化合租房源状态列表
    function subHouseList(){
    	$("#subLi").addClass('active');
    	$("#entireLi").removeClass('active');
    	$("#subTLi").removeClass('active');
    	exportUrl='house/houseDataListExcel?rentWay=1';
    	CommonUtils.strapTable('listTable','house/dataList',subPaginationParam,columnsData);
    }
    //初始化合租按套房源状态列表
    function subSharedHouseList(){
    	$("#subTLi").addClass('active');
    	$("#entireLi").removeClass('active');
    	$("#subLi").removeClass('active');
    	exportUrl='house/houseDataListExcel?rentWay=1000';
    	CommonUtils.strapTable('listTable','house/dataList',sharedPaginationParam,columnsData);
    }
</script>
</body>
