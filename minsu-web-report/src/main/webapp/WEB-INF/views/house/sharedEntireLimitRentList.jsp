...
<body class="gray-bg">
	...
	<div class="row row-lg">
         <div class="tabs-container">
			...
			<li >
				<a href="house/toLimitHouseList">整租列表</a>
			</li>
			<li >
				<a href="house/toLimitSharedRentList">合租列表</a>
			</li>
			<li class="active">
				<a href="javascript:void(0)">合租按套列表</a>
			</li>
		 </ul>
         </div>
		 <div class="col-sm-12">
					...
					<div class="example-wrap">
						<div class="example">
						 <table id="listTable" class="table table-bordered table-hover" data-click-to-select="true"
			                    ...
			                    data-height="500"
			                    data-url="house/limitCountDataList">
			                    <thead>
			                        <tr class="trbg">
			                        ...
			                        <th data-field="publish" data-width="10%" data-align="center">发布量(套)</th>
			                        <th data-field="guardRejict" data-width="10%" data-align="center">管家审核未通过</th>
			                        <th data-field="guardAccept" data-width="10%" data-align="center">管家审核通过</th>
			                        <th data-field="qualityReject" data-width="10%" data-align="center">品质审核未通过</th>
			                        <th data-field="on" data-width="10%" data-align="center">上架量</th>
			                        <th data-field="off" data-width="10%" data-align="center">下架量</th>
			                        <th data-field="forceOff" data-width="10%" data-align="center">强制下架量</th>
...
<script type="text/javascript">
    ...
    function exportFile(){
		...
		var url = "house/houseLimitListExcel?rentWay=1000"+
		"&beginTime="+beginTime+
		"&endTime="+endTime+
		"&cityCode="+cityCode
		;
