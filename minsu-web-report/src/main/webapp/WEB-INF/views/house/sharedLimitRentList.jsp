...
<body class="gray-bg">
	...
	<div class="row row-lg">
         <div class="tabs-container">
			...
			<li >
			   <a href="house/toSharedEntireLimitRentList">合租按套列表</a>
		    </li>
		 </ul>
         </div>
		 <div class="col-sm-12">
						...
						<div class="example">
						 <table id="listTable" class="table table-bordered table-hover" data-click-to-select="true"
			                    ...
			                    <thead>
			                        ...
			                        <th data-field="publish" data-width="10%" data-align="center">发布量(间)</th>
...
<script type="text/javascript">
    ...
    function exportFile(){
		...
		var url = "house/houseLimitListExcel?rentWay=1"+
		"&beginTime="+beginTime+
		"&endTime="+endTime+
		"&cityCode="+cityCode
		;
