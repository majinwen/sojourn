...
<script type="text/javascript">
    ...
    function init(){
        $("#jqGrid").jqGrid({
            url: 'orderHouse/orderHouseList',
            mtype: "GET",
            datatype: "json",
            colModel: [
                {label: '大区', name: 'regionName', key: true, width: 75},
                {label: '城市', name: 'cityName', width: 100},
                {label: '发布', name: 'fabuNum', width: 100},
                {label: '上架', name: 'shangjiaNum', width: 100},
                {label: '地推发布', name: 'dituiFabuNum', width: 100},
                {label: '地推上架', name: 'dituiShangjiaNum',width: 100},
                {label: '自主发布', name: 'zizhuFabuNum', width: 100},
                {label: '自主上架', name: 'zizhuShangjiaNum', width: 100},
                {label: '订单数', name: 'orderNum', width: 100},
                {label: '间夜', name: 'dayNum', width: 100}
            ],
    ...
    function exportFile(){
        ...
        window.location.href = "orderHouse/orderHouseListExcel?starTimeStr="+starTimeStr+"&endTimeStr="+endTimeStr+"&nationCode="+nationCode;
    }
