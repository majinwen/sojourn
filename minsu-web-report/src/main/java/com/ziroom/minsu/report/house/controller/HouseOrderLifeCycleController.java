...
import com.ziroom.minsu.report.house.service.HouseOrderLifeCycleService;
...
@Controller
@RequestMapping("/houseOrderLifeCycle")
public class HouseOrderLifeCycleController {
	/**
	 * 日志对象
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(HouseOrderLifeCycleController.class);
	
    @Resource(name = "report.houseOrderLifeCycleService")
    HouseOrderLifeCycleService houseService;
     ...
     * @return
     */
    @RequestMapping("/toEntireHouseOrderLifeCycle")
    public  ModelAndView toEntireHouseOrderLifeCycle(HttpServletRequest request){
    	ModelAndView maView  = new ModelAndView("/house/houseOrderLifeCycle/entireHouseOrderLifeCycle");
     ...
     * @return
     */
    @RequestMapping("/toSubHouseOrderLifeCycle")
    public  ModelAndView toSubHouseOrderLifeCycle(HttpServletRequest request){
    	ModelAndView maView  = new ModelAndView("/house/houseOrderLifeCycle/subHouseOrderLifeCycle");
    	List<Map<String,String>> cityMapList = this.getCityList(); 
        maView.addObject("cityList", cityMapList);
  ...
  public void houseOrderExcelList(HouseRequest paramRequest,HttpServletResponse response) {
       ...
       test.exportExcelOrZip(response, "getPageInfo", "房源订单周期报表");
