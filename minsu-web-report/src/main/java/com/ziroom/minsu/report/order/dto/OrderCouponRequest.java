 ...
 * @since 1.0
 */
public class OrderCouponRequest extends CityRegionRequest {
     ...
     * @return
     */
    public static OrderCouponRequest clone2negative(OrderCouponRequest old){

        OrderCouponRequest newObj = new OrderCouponRequest();
