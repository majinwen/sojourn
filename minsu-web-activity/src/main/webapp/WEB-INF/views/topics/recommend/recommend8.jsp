...
<div class="swiper-container">
	    <div class="swiper-wrapper">
	        <div class="swiper-slide" id="swiper-slide1">
				...
				<div class="banner" style="padding: 0; margin: 0;"><img src="${staticResourceUrl}/img/s8/1.jpg" width="100%" alt=""><div class="arrow"></div></div>
	        </div>
	        	...
	        	<div class="s2" id="main">
	        				<div class="main">
	        					...
	        					<ul class="listImg">
									...
									<li>
										<img src="${staticResourceUrl}/img/s8/2.jpg" width="100%" alt="">
		        						
		        						
									</li>
	        						
	        						<li>
	        							<img src="${staticResourceUrl}/img/s8/3.jpg" width="100%" alt="">
	        						</li>
	        						<li>
	        							<img src="${staticResourceUrl}/img/s8/4.jpg" width="100%" alt="">

	        						</li>
	        						<li>
	        							<img src="${staticResourceUrl}/img/s8/5.jpg" width="100%" alt="">
	        							
	        						</li>
	        						<li>
	        							<img src="${staticResourceUrl}/img/s8/6.jpg" width="100%" alt="">
	        						</li>
	        						<li class="s1">
	        							<img src="${staticResourceUrl}/img/s8/7.jpg" width="100%" alt="">
	        						</li>	        						
