...
<div class="swiper-container">
	    <div class="swiper-wrapper">
	        <div class="swiper-slide" id="swiper-slide1">
				...
				<div class="banner" style="padding: 0; margin: 0;"><img src="${staticResourceUrl}/img/s7/1.jpg" width="100%" alt=""><div class="arrow"></div></div>
	        </div>
	        	...
	        	<div class="s2" id="main">
	        				<div class="main">
	        					...
	        					<ul class="listImg">
									...
									<li>
										<img src="${staticResourceUrl}/img/s7/2.jpg" width="100%" alt="">
		        						
		        						
									</li>
	        						
	        						<li>
	        							<img src="${staticResourceUrl}/img/s7/3.jpg" width="100%" alt="">
	        						</li>
	        						<li>
	        							<img src="${staticResourceUrl}/img/s7/4.jpg" width="100%" alt="">

	        						</li>
	        						<li>
	        							<img src="${staticResourceUrl}/img/s7/5.jpg" width="100%" alt="">
	        							
	        							
	        						</li>
	        						<li>
	        							<img src="${staticResourceUrl}/img/s7/6.jpg" width="100%" alt="">
	        						</li>
	        						<li class="s1">
	        							<img src="${staticResourceUrl}/img/s7/7.jpg" width="100%" alt="">
	        						</li>

	        						<li class="">
	        							<img src="${staticResourceUrl}/img/s7/8.jpg" width="100%" alt="">
	        						</li>
	        						<li>
	        							<img src="${staticResourceUrl}/img/s7/9.jpg" width="100%" alt="">
	        						</li>
