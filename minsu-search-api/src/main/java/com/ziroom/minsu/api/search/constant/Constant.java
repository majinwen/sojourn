 ...
 */
package com.ziroom.minsu.api.search.constant;
...
public class Constant {
     ...
     * t_conf_city表顶层节点编码
     */
    public static final String T_CONF_CITY_ROOT_CODE = "CY";
    /**
     * 5.1.6 ios版本的top50 注释掉
     */
    public static final String APP_IOS_VERSION_NAME = "5.1.6";
}
