...
<div class="main">
    <div id="appBox" class="mainBox">
        ...
        <div class="topBoxQc">
            <div class="img"><img src="${staticResourceUrl}/activity/invite/images/feiji.png"></div>
            <div class="liucheng"><img src="${staticResourceUrl}/activity/invite/images/liucheng.png">
                <p>${money}</p>
            </div>
        </div>
        <div class="bottomBox">
            <div class="con">
                ...
                <!--app里显示 立即启程按扭-->
                <!-- <div class="btns">
                    <a href="javascript:;" class="btn" id="" ><img src="images/btn_qicheng.png" alt="立即启程"></a>
