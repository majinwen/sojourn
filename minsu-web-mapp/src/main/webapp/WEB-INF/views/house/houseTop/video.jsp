...
<head>
    ...
    <style>
        ...
        #video{position: absolute;top:25%;left:0;width:100%;}
        #bg{background:rgba(0,0,0,.6);overflow: hidden;width: 100%;height: 100%;}
    </style>
</head>
<body>
<div class="bg" id="bg">
    <!-- 视频 -->
   <!--  <p class="S_video" id="video">
        <iframe id="J_iframe" style="z-index:1;" src="" allowfullscreen frameborder="0" autoplay="1"></iframe>
    </p> -->
    <div class="S_video" id="video">
       <iframe id="J_iframe" style="z-index:1;" src="${videoUrl }" allowfullscreen="" autoplay="1" frameborder="0">
       </iframe>
    </div>
</div>
