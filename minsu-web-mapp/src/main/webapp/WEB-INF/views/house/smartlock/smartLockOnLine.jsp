...
>>>>>>> refs/remotes/origin/test
			...
			<div class="main">	
				<div class="mima">	
					<div class="rBox">
						<div id="refreshStatus" class="c">	
							<h2>正常</h2>
							<p>电池电量${power}%</p>
							<span class="r"></span>
						</div>
						
						<span class="y circle_change"></span>
						<span class="y circle_change2"></span>
					</div>

					<a class="mBtn" href="${basePathHttps }smartLock/${loginUnauth}/appForTempPass?houseBaseFid=${houseBaseFid}&houseRoomFid=${houseRoomFid}&rentWay=${rentWay}">申请临时密码</a>

					<div class="bottomBtns">	
<<<<<<< HEAD
						<a href="${basePath }smartLock/${loginUnauth}/upPermanentPass?houseBaseFid=${houseBaseFid}&houseRoomFid=${houseRoomFid}&rentWay=${rentWay}" class="s">管理密码:${pass }</a>
						<a href="http://minsustatic.ziroom.com/mapp/html/door_lock_instructions.html" class="w">智能锁说明</a>
=======
						<a href="${basePathHttps }smartLock/${loginUnauth}/upPermanentPass?houseBaseFid=${houseBaseFid}&houseRoomFid=${houseRoomFid}&rentWay=${rentWay}" class="s">管理密码:${pass }</a>
