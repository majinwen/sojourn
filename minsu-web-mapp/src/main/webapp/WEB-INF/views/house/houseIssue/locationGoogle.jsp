...
<body>
	...
	<!-- <script type="text/javascript" src="http://maps.google.cn/maps/api/js?sensor=false&key=AIzaSyBGDl4n8U3DxRnV0e7gEXnFtF39d7-9dwc"></script> -->
	<script type="text/javascript" src="${staticResourceUrl}/js/google.js${VERSION}003&sensor=false"></script> 
