 ...
 * @version 1.0
 */
public class MsgBaseOfflineEntity extends BaseEntity{
    private static final long serialVersionUID = -8619832466206064522L;
    /**
     * 编号
     */
    private Integer id;
    ...
    public void setMsgRealContent(String msgRealContent) {
        this.msgRealContent = msgRealContent == null ? null : msgRealContent.trim();
    }
