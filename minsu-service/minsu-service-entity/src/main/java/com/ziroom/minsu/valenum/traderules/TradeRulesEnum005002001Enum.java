 ...
 * @since 1.0
 */
public enum  TradeRulesEnum005002001Enum {

    TradeRulesEnum005002001001("TradeRulesEnum005002001001","免费提前退订最小天数","入住日期前x天取消预订，","提前x天取消订单，退还房客全部房费;"){
        @Override
		...
		public String trans1ShowName(TradeRulesVo tradeRulesVo){
			...
			if(!Check.NuNObj(tradeRulesVo)){
				...
				String name = TradeRulesEnum005002001001.getCheckInPreNameM();
		...
		public String trans1ShowNameOld(TradeRulesVo tradeRulesVo){
			...
			if(!Check.NuNObj(tradeRulesVo)){
				...
				String name = TradeRulesEnum005002001001.getCheckInPreNameOldM();
				name = name.replace("x",String.valueOf(tradeRulesVo.getUnregText1()));
				tradeRulesVo.setCheckInPreNameM(name);
			}
    ...
    TradeRulesEnum005002001002("TradeRulesEnum005002001002","违约需扣房租天数","","入住前x天内取消订单，扣除房客y日房费;"){
        @Override
        public void trans2Rull(CheckOutStrategy vo, Object value) {
            if(!Check.NuNObj(vo)){
                vo.setMoneyType(CheckOutMoneyTypeEnum.DAY.getCode());
		...
		public String trans1ShowNameOld(TradeRulesVo tradeRulesVo){
			...
			if(!Check.NuNObj(tradeRulesVo)){
				...
				String name = TradeRulesEnum005002001002.getCheckInPreNameOldM();
    ...
    TradeRulesEnum005002001003("TradeRulesEnum005002001003","入住后提前退房需扣房租天数","如果提前退房，","入住后提前退房，扣除房客y日房费;"){
        @Override
        public void trans2Rull(CheckOutStrategy vo, Object value) {
            if(!Check.NuNObj(vo)){
                vo.setMoneyType(CheckOutMoneyTypeEnum.DAY.getCode());
		...
		public String trans1ShowName(TradeRulesVo tradeRulesVo){
			...
			if(!Check.NuNObj(tradeRulesVo)){
				...
				String name = TradeRulesEnum005002001003.getCheckInPreNameM();
		...
		public String trans1ShowNameOld(TradeRulesVo tradeRulesVo){
			...
			if(!Check.NuNObj(tradeRulesVo)){
				...
				String name = TradeRulesEnum005002001003.getCheckInPreNameOldM();
    ...
    TradeRulesEnum005002001004("TradeRulesEnum005002001004","无责任退房扣除全部房租百分比","",""){
        @Override
        public void trans2Rull(CheckOutStrategy vo, Object value) {
            if(!Check.NuNObj(vo)){
                vo.setMoneyType(CheckOutMoneyTypeEnum.DAY.getCode());
    ...
    TradeRulesEnum005002001005("TradeRulesEnum005002001005","取消订单剩余房租扣除百分比","如果未能在{1}天前取消预订，",""){
        @Override
        public void trans2Rull(CheckOutStrategy vo, Object value) {
            if(!Check.NuNObj(vo)){
                vo.setMoneyType(CheckOutMoneyTypeEnum.DAY.getCode());
		...
		public String trans1ShowName(TradeRulesVo tradeRulesVo){
			...
			if(!Check.NuNObj(tradeRulesVo)){
				...
				String name = TradeRulesEnum005002001005.getCheckInPreNameM();
    ...
    TradeRulesEnum005002001006("TradeRulesEnum005002001006","退房剩余房租扣除百分比","",""){
        @Override
        public void trans2Rull(CheckOutStrategy vo, Object value) {
            if(!Check.NuNObj(vo)){
                vo.setMoneyType(CheckOutMoneyTypeEnum.DAY.getCode());
	...
	TradeRulesEnum005002001007("TradeRulesEnum005002001007","无责任退房需扣房租天数","",""){
		@Override
		public void trans2Rull(CheckOutStrategy vo, Object value) {
			if(!Check.NuNObj(vo)){
				vo.setMoneyType(CheckOutMoneyTypeEnum.DAY.getCode());
     ...
     * @return
     */
    public static TradeRulesEnum005002001Enum getEmbyCode(String value) {
        for (final TradeRulesEnum005002001Enum em : TradeRulesEnum005002001Enum.values()) {
    ...
    TradeRulesEnum005002001Enum(String value, String name,String checkInPreNameM,String checkInPreNameOldM) {
        this.value = value;
        this.name = name;
        this.checkInPreNameM = checkInPreNameM;
    	this.checkInPreNameOldM = checkInPreNameOldM;
