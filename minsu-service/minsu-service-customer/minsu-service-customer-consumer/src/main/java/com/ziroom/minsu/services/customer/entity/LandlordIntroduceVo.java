...
public class LandlordIntroduceVo implements Serializable{
	 ...
	 * 评价分数
	 */
	private float  eva = ValueUtil.getEvaluteSoreDefault(null).floatValue();
	...
	public String getHeadPicUrlOrg() {
		return headPicUrlOrg;
	}

	public void setHeadPicUrlOrg(String headPicUrlOrg) {
		this.headPicUrlOrg = headPicUrlOrg;
	}
}
