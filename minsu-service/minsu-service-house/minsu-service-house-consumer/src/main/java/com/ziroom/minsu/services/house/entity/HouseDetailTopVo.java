/**
 * @FileName: HouseDetailTopVo.java
 * @Package com.ziroom.minsu.services.house.entity
 * 
 * @author yd
 * @created 2017年3月15日 上午11:09:11
 * 
 ...
 * @version 1.0
 */
public class HouseDetailTopVo implements Serializable{


	/**
	 * 序列id
	 */
	private static final long serialVersionUID = 7723925718001173908L;
	 ...
	 * 一条评论信息
	 */
	private TenantEvalVo tenantEvalVo = new TenantEvalVo();
     ...
     * 房源名称下-房源信息展示
     */
    private LinkedList<String> houseNameInfoList = new LinkedList<String>();
    
    /**
     * 房源 设施 默认展示5个
     */
    private LinkedList<EnumVo> listHouseFacilities = new LinkedList<EnumVo>();
    
    /**
     * 房源的服务  设施  电器 卫浴 列表
     */
    private LinkedList<EnumVo> listHouseFacServ = new LinkedList<EnumVo>();
    
    /**
     * 入住规则
     */
    private LinkedList<CheckRuleVo> listCheckRuleVo = new LinkedList<CheckRuleVo>();
     ...
     *  基础房源标签
     */
    private List<LabelTipsEntity> labelTipsList = new LinkedList<LabelTipsEntity>();
