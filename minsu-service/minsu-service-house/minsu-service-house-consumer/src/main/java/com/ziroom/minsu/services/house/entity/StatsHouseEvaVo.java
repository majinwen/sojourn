...
public class StatsHouseEvaVo {
	 ...
	 * 真实的综合评价分
	 */
	private Float realTotalAvgGrade;	
	...
	public Float getRealTotalAvgGrade() {
		return realTotalAvgGrade;
	}
	public void setRealTotalAvgGrade(Float realTotalAvgGrade) {
		this.realTotalAvgGrade = realTotalAvgGrade;
	}
	/**
