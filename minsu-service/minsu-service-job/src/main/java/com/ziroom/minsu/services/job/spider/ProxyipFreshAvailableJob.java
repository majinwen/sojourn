 ...
 * @since 1.0
 */
public class ProxyipFreshAvailableJob extends AsuraJob {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProxyipFreshAvailableJob.class);

    private static final String logPreStr = "代理ip刷新可用性 ProxyipFreshAvailableJob-";
